...
@AllArgsConstructor
@Log4j2
public class RandomNumberGeneratorRestTemplate implements IRandomNumberGenerable {
    ...
    private String getUrlForService() {
        return uri + ":" + port + RandomNumberGeneratorRestTemplate.RANDOM_NUMBER_SERVICE_PATH;
    }
}
